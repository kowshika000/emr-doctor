...
export const CurrentPatient = ({ patientData }) => {
                    ...
                    <div className="d-flex gap-5">
                      <div className="profile_dispaly">
                        ...
                        <div className="profile_info_body">
                          <div>{truncateWithTooltip(data?.name)}</div>
                          <div>{data?.age}</div>
                          <div>{data?.gender}</div>
                        </div>
                      </div>
                      <div className="profile_dispaly">
                        ...
                        <div className="profile_info_body">
                          <div>{truncateWithTooltip(data?.address)}</div>
                          <div>{data?.phoneNo}</div>
                          <div>{truncateWithTooltip(data?.emailId)}</div>
                        </div>
                      </div>
                    </div>
                  </div>
